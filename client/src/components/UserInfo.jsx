                    ...
                    <>
                        ...
                        >
                            <PopoverPanel className="absolute left-1/2 z-10 mt-3 w-80 max-w-sm -translate-x-1/2 transform px-4 sm:px-0">
                                <div className='flex items-center rounded-lg shadow-lg bg-white p-4 gap-4'>
                                    <div className='w-16 h-16 bg-blue-600 rounded-full text-white items-center flex justify-center text-2xl'>
