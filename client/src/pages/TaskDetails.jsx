                      ...
                      <div className="space-y-3">
                        {
                            task?.team?.map((team,index)=>(
                              <div className={
                                "flex gap-4 py-2 items-center border-t border-gray-200"
                              }>
                              <div className="w-10 h-10 rounded-full text-white flex items-center justify-center text-sm -mr-1 bg-blue-600">
                                    <span className="texy-center">{getInitials(team?.name)}</span>
                              </div>
                              <div className="flex flex-col">
                                <span className="font-semibold">{team?.name}</span>
                                <span className="text-gray-500 text-sm">{team?.title}</span>
                              </div>
                      ...
                      <div key={index} className='flex gap-3'>
                        ...
                        <div className='space-y-1'>
                          <div className='flex gap-2 items-center'>
                            ...
                            <span className='px-2 py-0.5 text-center capitalize text-sm rounded-full bg-violet-100 text-violet-700 font-semibold'>
                              {el?.tag}
                            </span>
                          </div>
